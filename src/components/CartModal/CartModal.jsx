...
Productos agregados recientemente</h5>
      {
        (carts?.length > 0) ? (
          <div className='cart-modal-list grid'>
            ...
            <div className='text-capitalize view-cart-btn bg-orange fs-15 font-manrope text-center'>ver mi carrito de compras</div>
          </div>) : (
          <div className = "flex flex-column align-center justify-center cart-modal-empty">
            <img src = {shopping_cart} alt = "" className='' />
            <h6 className='text-dark fw-4'>No hay productos todavía</h6>
          </div>
        )
      }
    </div>
